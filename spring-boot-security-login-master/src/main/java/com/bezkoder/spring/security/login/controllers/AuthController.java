...
@CrossOrigin(origins = "*", maxAge = 3600, allowedHeaders = "*", exposedHeaders = "access-token")
@RestController
...
public class AuthController {
  ...
  public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
    ...
    //myHeaders.add("accessToken", jwtCookie.toString());

    return ResponseEntity.ok().headers(myHeaders)
